...
## How to get it:
You can download the binary suitable for your system [from the Releases tab](https://github.com/Isaac-Subirana/what/releases) of this repository, and add it to your PATH (on Linux, you will need to mark it as executable). 
